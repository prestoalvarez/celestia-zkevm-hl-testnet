...
use ev_prover::command::{create_ism, init, query, set_token_ism, start, unsafe_reset_db, version, Cli, Commands};
...
async fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        Commands::SetTokenIsm { ism_id, token_id } => set_token_ism(ism_id, token_id).await?,
